...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '紫电穿云', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Zidy2012', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zidy.eu.org', // 网站地址
  ...
  // 星空雨特效 黑夜模式才会生效
  STARRY_SKY: process.env.NEXT_PUBLIC_STARRY_SKY || false, // true
